...
Install VIC with version to Test Server
    ...
    Install VIC Appliance To Test Server  vic-machine=./vic_${version}/vic/vic-machine-linux  appliance-iso=./vic_${version}/vic/appliance.iso  bootstrap-iso=./vic_${version}/vic/bootstrap.iso  certs=${false}  cleanup=${cleanup}  vol=default ${insecureregistry}
